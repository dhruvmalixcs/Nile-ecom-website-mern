            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">1087 ratings</p>
                  <p className="ml-3 text-indigo-600 font-medium text-sm hover:text-indigo-500 ">
                    333 reviews
                  </p>
                </div>
              </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">501 Ratings</p>
                </div>
                <Box className="mt-5">
